...
export function ChatSidebar({ className }: ChatSidebarProps) {
  ...
  return (
    <div
      className={cn(
        'w-20 bg-white/80 backdrop-blur-sm border-r border-amber-200/50 flex flex-col items-center py-6 space-y-4',
        className
      )}
    >
      {/* Logo */}
...
export function TemplateSidebar({
  ...
  return (
    <div
      className={cn(
        'w-80 bg-[var(--card)]/60 backdrop-blur-sm border-l border-[var(--border)] p-6',
        className
      )}
    >
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <h5 className="font-semibold text-[var(--foreground)] text-sm group-hover:text-[var(--primary)]">
                          {template.title}
                        </h5>
